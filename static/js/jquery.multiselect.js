    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            if( instance.options.search ) {
                optionsList.before('<div class="ms-search"><input class="input" type="text" value="" placeholder="'+ instance.options.texts.search +'" /></div>');
            ...
            if( instance.options.selectAll ) {
                optionsList.before('<p class="ms-selectall global">' + instance.options.texts.selectAll + '</p>');
            }
                ...
                // OPTGROUP
                    ...
                    if( appendContainer ) {
                        ...
                        if( instance.options.selectGroup ) {
                            container.append('<p class="ms-selectall">' + instance.options.texts.selectAll + '</p>');
                        }
